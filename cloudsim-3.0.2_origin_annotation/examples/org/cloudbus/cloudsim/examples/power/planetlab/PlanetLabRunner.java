...
public class PlanetLabRunner extends RunnerAbstract {
	...
	protected void init(String inputFolder) {
		try {
			CloudSim.init(1, Calendar.getInstance(), false);//初始化CloudSim

			broker = Helper.createBroker();//创建代理
			int brokerId = broker.getId();//取得代理的ID

			cloudletList = PlanetLabHelper.createCloudletListPlanetLab(brokerId, inputFolder);//workload/planetlab/888
