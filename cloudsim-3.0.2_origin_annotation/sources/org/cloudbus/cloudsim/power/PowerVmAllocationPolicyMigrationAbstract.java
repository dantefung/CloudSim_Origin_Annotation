...
public abstract class PowerVmAllocationPolicyMigrationAbstract extends PowerVmAllocationPolicyAbstract {
	...
	public PowerVmAllocationPolicyMigrationAbstract(
		...
		super(hostList);
		setVmSelectionPolicy(vmSelectionPolicy);//设置虚拟机的挑选策略mmt
	}
	...
	public List<Map<String, Object>> optimizeAllocation(List<? extends Vm> vmList) {
		ExecutionTimeMeasurer.start("optimizeAllocationTotal");//测量执行时间。

		ExecutionTimeMeasurer.start("optimizeAllocationHostSelection");
		List<PowerHostUtilizationHistory> overUtilizedHosts = getOverUtilizedHosts();//取出超过利用率阈值的主机。
